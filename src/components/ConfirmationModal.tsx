...
interface ConfirmationModalProps {
    isOpen: boolean;
    onClose: () => void;
    /** Необязателен: состояние модалки закрывают объектом { isOpen: false },
     *  в котором обработчиков уже нет. */
    onConfirm?: () => void;
    onCancelAction?: () => void;
    title?: ReactNode;
    children?: ReactNode;
    confirmText?: string;
    cancelText?: string;
    /** Красит кнопку подтверждения в «опасный» вид — для удаления и выхода. */
