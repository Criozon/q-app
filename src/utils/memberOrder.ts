...
/**
 * Отменённые стоят выше закончённых намеренно: именно их приходят
 * искать. Человек не услышал вызова, вернулся через полчаса — админ
 * находит его сразу под списком ожидающих, а не в хвосте за всеми,
 * кого сегодня обслужили.
 *
...
const RANK: Record<MemberStatus, number> = {
    ...
    cancelled: 3,    // не подошли — этих чаще всего и возвращают
    serviced: 4,     // закончили, пусть оседают в самом низу
};
